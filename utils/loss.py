...
class BCELoss(nn.Module):
    def __init__(self, weight=None, size_average=True):
        ...
        self.bceloss = nn.BCELoss(weight=weight, reduction='mean' if size_average is not False else 'sum')
...
class DeepSupervisionLoss(nn.Module):
    def __init__(self, typeloss="StructureLoss"):
    ...
    def forward(self, pred, gt):
        ...
        loss0 = self.criterion(torch.sigmoid(d0), gt) * 1.0
